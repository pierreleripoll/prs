...
def send_file_asynchronev3(sockdata, addr, fichier, max_segment, TAILLE, FENETRE,last_packet, last_error, timeout_error):
	numero = 0
	last_packet_fix = -1
	last_error_fix = -1
...
p.start()
send_file_asynchronev3(sockdata, addr, fichier, max_segment, TAILLE, FENETRE,last_packet, last_error, timeout_error,)
